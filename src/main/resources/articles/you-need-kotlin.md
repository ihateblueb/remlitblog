...
The title is a little absurd, I know, but I thought it was funny.
...
served by the Kotlin HTTP framework, and the layout HTML was generated by the Kotlin HTML DSL, and the markdown file
...
Kotlin does not have a ternary (`condition ? true : false`) but instead reccomends using inline if statements.
